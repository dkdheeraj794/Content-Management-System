     ...
     <?php require_once('inc/header.php');?>
        ...
        <div class="container-fluid body">
          ...
          <div class="col-md-9">
              ...
              <h1><i class="fa fa-tachometer" aria-hidden="true"></i>  Categories <small>Diffrent Categories</small></h1><br>
                <ol class="breadcrumb">
                    ...
                    <hr>
                     ...
                     <form action="" method="post">
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="Update Category Name" class="form-control" name="cat-name" value="<?php echo $up_category;?>">
                      </div>
                  ...
                  <table class="table table-hover table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="categories.php?edit=<?php echo $category_id;?>"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                        <td><a href="categories.php?del=<?php echo $category_id;?>"><i class="fa fa-times" aria-hidden="true"></i></a></td>
