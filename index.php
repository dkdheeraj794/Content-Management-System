...
<div class="jumbotron">
      <div class="container">
            <div id="details" class="animated fadeInLeft">
                  <h1 class="animate__animated animate__swing">Dheeraj Kumar<span>  Blog</span></h1>
      ...
      <div class="container">
         ...
         echo "<li data-target='#carouselExampleIndicators' data-slide-to='".$i."'  class='active'></li>";
                        ...
                        ?>
                                                  ...
                                                  <a href="post.php?post_id=<?php echo $slider_id;?>"><img class="d-block w-100" src="img/<?php echo $slider_image;?>" alt="First slide">
                                                  </a>
...
<footer class="mojFooter">
  <div class="container text-center">
      Copyright &copy; by <a href="">Dheeraj Kumar</a>.
